...
<meta name="theme-color" content="#1A1816"><link rel="manifest" href="/manifest.json"><title>TaskFlow</title>
...
app.get('/manifest.json',(_,res)=>res.json({name:"TaskFlow",short_name:"TaskFlow",description:"Smart task manager with WhatsApp integration",start_url:"/",display:"standalone",orientation:"portrait",background_color:"#F5F2ED",theme_color:"#1A1816",categories:["productivity","utilities"],icons:[{src:"https://ui-avatars.com/api/?name=TF&background=1A1816&color=3DAE5C&size=192&bold=true&format=png",sizes:"192x192",type:"image/png",purpose:"any"},{src:"https://ui-avatars.com/api/?name=TF&background=1A1816&color=3DAE5C&size=512&bold=true&format=png",sizes:"512x512",type:"image/png",purpose:"any maskable"}]}));
