...
// Force email login \u2014 WhatsApp Sandbox requires per-recipient join code (Twilio limitation). WA Business API coming.
S.loginMethod='email';
...
h+='<div class="login-hint" style="margin-top:14px;font-size:11px;opacity:.65">WhatsApp login coming soon \\u2014 currently in beta and requires manual setup.</div>';
