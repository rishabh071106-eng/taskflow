...
const EMAIL_FROM=process.env.EMAIL_FROM||'Taskit <onboarding@resend.dev>';
...
app.post('/api/send-otp-email',async(req,res)=>{
  ...
  const html=`<div style="font-family:-apple-system,Segoe UI,sans-serif;max-width:480px;margin:0 auto;padding:32px 24px;background:#F5F2ED;border-radius:16px">
    <div style="text-align:center"><h1 style="font-family:monospace;font-size:30px;margin:0;color:#2D2A26">Tas<span style="color:#3DAE5C">k</span>it</h1></div>
    ...
    <p style="color:#9C968D;font-size:11px;text-align:center">Taskit — Tasks, Books &amp; Wisdom in one place.</p>
  </div>`;
  const r=await sendEmail(email,'Your Taskit code: '+code,html);
